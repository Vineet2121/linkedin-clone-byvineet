...
function Form() {
  ...
  return (
    <form className="relative flex flex-col space-y-2 text-black/80 dark:text-white/75">
      ...
      <button
        className="absolute bottom-0 right-0 rounded-full bg-blue-400 px-3.5 py-1 font-medium text-white hover:bg-blue-500 disabled:cursor-not-allowed disabled:bg-white/75 disabled:text-black/40"
        type="submit"
        onClick={uploadPost}
